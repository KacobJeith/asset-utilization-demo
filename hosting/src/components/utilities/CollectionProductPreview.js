...
var mapStateToProps = (state, ownProps) => ({
  product: state.collections[ownProps.collectionName].products[ownProps.productIndex],
});
...
class CollectionProductPreview extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      hover: false,
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(CollectionProductPreview)))
