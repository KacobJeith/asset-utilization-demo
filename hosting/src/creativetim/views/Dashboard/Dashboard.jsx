      ...
      <div>
        ...
        <Grid container>
          <GridItem xs={12} sm={12} md={4}>
            <Card chart>
              ...
              <CardBody>
                <h4 className={classes.cardTitle}>Overall Engagement (thousands)</h4>
                <p className={classes.cardCategory}>
                  <span className={classes.successText}>
                    <ArrowUpward className={classes.upArrowCardCategory} /> 15%
                  </span>{" "}
                  Cumulative Engagement this week
                </p>
              </CardBody>
              <CardFooter chart>
                <div className={classes.stats}>
          ...
          <GridItem xs={12} sm={12} md={4}>
            <Card chart>
              ...
              <CardBody>
                <h4 className={classes.cardTitle}>Exhibit Performance</h4>
                <p className={classes.cardCategory}>
                  Engagement Performance per Exhibit
                </p>
              </CardBody>
              <CardFooter chart>
                <div className={classes.stats}>
                  <AccessTime /> calculated 4 days ago
                </div>
              </CardFooter>
            </Card>
          </GridItem>
          <GridItem xs={12} sm={12} md={4}>
            <Card chart>
              ...
              <CardBody>
                <h4 className={classes.cardTitle}>Today's Engagement</h4>
                <p className={classes.cardCategory}>
                  <span className={classes.successText}>
                    <ArrowUpward className={classes.upArrowCardCategory} /> 8%
                  </span>{" "}
                  Engagement is up this hour!
                </p>
              </CardBody>
              <CardFooter chart>
                <div className={classes.stats}>
        ...
        <Grid container>
          ...
          <GridItem xs={12} sm={12} md={6}>
            <Card>
              <CardHeader color="warning">
                <h4 className={classes.cardTitleWhite}>Exhibit Engagement Details</h4>
